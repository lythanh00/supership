...
public class ShipmentConverter {
    ...
    public ShipmentEntity toEntity(ShipmentDTO dto){
        ...
        entity.setSourceStoreId(dto.getSourceStoreId());
        entity.setDestinationStoreId(dto.getDestinationStoreId());
    ...
    public ShipmentDTO toDTO(ShipmentEntity entity){
        ...
        dto.setSourceStoreId(entity.getSourceStoreId());
        dto.setDestinationStoreId(entity.getDestinationStoreId());
